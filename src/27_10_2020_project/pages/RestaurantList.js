...
import { RestaurantItem, SearchBar } from '../component';
...
const RestaurantList = (props) => {
    ...
    /*
    program calisir calismaz useState dolar, doldurunca direk originalList i doldurur, filter islemi sirasinda filtreleme islemi originalList uzerinden yapilir ve useState e kaydedilir

    ORIGINALLIST sadece program yeniden calistiginda dolar
    */
